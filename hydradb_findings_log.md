...
- **Where**: `scripts/test_knowledge_graph_relations.py`, `data/_knowledge_graph_relations_test_results.json`, tenant `stock-market-decoder`; cross-checked against `dashboard.hydradb.com/graph` for the `stock-market-decoder`/`default` tenant.

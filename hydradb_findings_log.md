...
### 24. Cross-document entity resolution (Tier 4 claim) does not reliably merge the same real-world entity across documents, including on the primary use case the claim's own pilot test was built to cover
